...
SQL_CURSOR.execute("CREATE TABLE IF NOT EXISTS Info (username TEXT, friends TEXT, groups TEXT)")
...
class RegisterPage(CTkFrame):
    ...
    def submitClick(page):
        ...
        SQL_CURSOR.execute("INSERT INTO Info (username, friends, groups) VALUES (?, ?, ?)", (username, "[]", "[]"))
        SQL.commit()
